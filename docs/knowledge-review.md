...
元連絡: `#0413b251a3`, `#0ed768680b`, `#c45b8c027a`
...
- song-owned: 感情主体、生命感、身体的な線、scene名、区間ごとの見た目、各曲のモチーフ、具体的な方向や落下表現。
- reject: すべての曲を有機的な動きに寄せること、単純な曲にも複数scene familyを必須にすること、特定の方向運動を共通ルールにすること。
